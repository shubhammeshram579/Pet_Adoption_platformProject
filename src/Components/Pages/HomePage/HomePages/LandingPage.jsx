    ...
    <div style={{paddingTop:"90px",minHeight:"120vh"} }>
      ...
      <div>
        <motion.div style={{ opacity ,scale,minHeight:"100vh"}} className="page1">
          ...
          <div className="card1">
            <motion.img whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }} onHoverStart={() => console.log('hover started!')} height={700} src={img} alt="" />
          </div>
      ...
      <div className="page2" style={{minHeight:"50vh" ,paddingTop:"100px" }}>
          ...
          <div className="card3 d-flex align-items-center justify-content-center" style={{gap:"60px"}}>
            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }} onHoverStart={() => console.log('hover started!')}  className="d-flex align-items-center flex-column">
